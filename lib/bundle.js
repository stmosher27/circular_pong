...
/***/ function(module, exports, __webpack_require__) {
	...
	document.addEventListener('DOMContentLoaded', function () {
	  ...
	  function restart(e) {
	    if (e.keyCode !== 32) game.renderInitialState();
	...
	var Ball = function () {
	  ...
	  _createClass(Ball, [{
	    ...
	    value: function updateAngle(radius, centerY) {
	      ...
	      if (this.ballX <= 350 && this.ballY >= 350) this.ballAngle = PI - this.ballAngle;
	      if (this.ballX < 350 && this.ballY < 350) this.ballAngle += PI;
	      if (this.ballX >= 350 && this.ballY <= 350) this.ballAngle = TWO_PI - this.ballAngle;
	      if (this.ballAngle >= TWO_PI) this.ballAngle -= TWO_PI;
	    }
	  }, {
	    key: "updateSpeed",
	    value: function updateSpeed() {
	      var newSpeeds = [[1, Math.sqrt(7)], [1.5, Math.sqrt(1.75)]];
